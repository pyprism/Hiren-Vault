    ...
    render() {
        return (
            <div>
                ...
                <nav className="navbar navbar-default no-margin navbar-fixed-bottom navbar-inverse">
                ...
                <div id="wrapper">
                    <div id="sidebar-wrapper">
                        <ul className="sidebar-nav nav-pills nav-stacked" id="menu">
                            <li>
                                <Link to="/dashboard/all/" ><span className="fa-stack fa-lg pull-left"><i className="fa fa-unlock-alt fa-stack-1x " /></span> Passwords</Link>
                            </li>
                            <li>
